🔸 Wi-Fi Deauth-атака (Deauthentication Attack) — это тип атаки на беспроводные сети, 
которая принудительно отключает клиентов от точки доступа (роутера) 
путем отправки поддельных управляющих фреймов. 
Это один из самых распространенных методов в тестировании на проникновение (пентесте) и хакерских атаках.

🔹 Как работает
В Wi-Fi (стандарт IEEE 802.11) управляющие фреймы
